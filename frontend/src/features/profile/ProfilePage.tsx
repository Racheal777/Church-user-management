  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 pb-32 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="px-4 lg:px-0">
         <div className="bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-blue-900/5 overflow-hidden relative">
         ...
         <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 space-y-8">
            ...
            <div className="flex justify-end pt-4">
               <button 
                 ...
                 className={clsx(
                   "px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 flex items-center gap-2",
                   hasChanges 
                     ? "bg-blue-700 text-white shadow-lg shadow-blue-900/10 hover:bg-blue-800" 
...
function InfoTile({ label, value, dotColor, status }: { label: string, value: string, dotColor?: string, status?: boolean }) {
  return (
    <div className="bg-white p-6 rounded-xl border border-slate-100/80 space-y-1">
